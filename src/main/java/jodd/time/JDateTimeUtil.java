...
public class JDateTimeUtil {
	...
	public static void main(String[] args) {
		JDateTimeUtil u = new JDateTimeUtil();
		u.testConstructor();
	}

	public void testConstructor() {
		/*** 构造函数的使用 */
		JDateTime jdt = new JDateTime(); // set current date and time 当前日期和时间
		// jdt = new JDateTime(2012, 12, 21); // set 21st December 2012,
		// midnight
		// Console.info(jdt.toString());
		// jdt = new JDateTime(System.currentTimeMillis());
		// Console.info(jdt.toString());
		// jdt = new JDateTime(2012, 12, 21, 11, 54, 22, 124); // set 21st
		// December 2012, 11:54:22.124
		// Console.info(jdt.toString());
		jdt = new JDateTime("2012-12-21 11:54:22.124"); // -//-
		log.info(jdt.toString());
		// jdt = new JDateTime("12/21/2012", "MM/DD/YYYY"); // set 21st December
		// 2012, midnight
		// jdt = new JDateTime(new Date());
	}
	...
	public void testSet() {
		 ...
		 * set方法的使用:设定日期时间
		 */
		jdt.set(2012, 12, 21, 11, 54, 22, 124); // set 21st December 2012,
												// 11:54:22.124
		jdt.set(2012, 12, 21); // set 21st December 2012, midnight
		jdt.setDate(2012, 12, 21); // change date to 21st December 2012, do not
									// change te time
	...
	public void testAdd() {
		JDateTime jdt = new JDateTime(); // set current date and time
		jdt.add(1, 2, 3, 4, 5, 6, 7); // add 1 year, 2 months, 3 days, 4
										// hours...
	...
	public void testFormat() {
		JDateTime jdt = new JDateTime(); // set current date and time
		/**
		 * 转换说明 YYYY 年 MM 月 DD 日 D 一周中的第几天 从周一算起 MML 月,长型 MMS 月,短行 DL 一周中的第几天 长型
		 * 从周一算起 DS 一周中的第几天 短型 从周一算起 hh 小时 mm 分钟 ss 秒 mss 毫秒 DDD 一年中的第几天 WW
		 * 一年中的第几周 WWW 一年中的第几周并用W标识 W 一个月中的第几周 E 年代,公元前还是公元后 TZL 时间长型 TZS 时间短型
		 * 
		 */
