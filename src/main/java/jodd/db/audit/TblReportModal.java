...
public class TblReportModal implements java.io.Serializable, Cloneable {
	...
	/** full constructor */
	public TblReportModal(String fsn, String fprojectId, String freportCode,
			String freportName, String ffilePath, String femployee,
			Integer femployeeId, Date ftime, String fmemo) {
		this.fsn = fsn;
